 ...
 * @returns {number} - Returns a negative value if `a` should come before `b`, a positive value if `a` should come after `b`, or 0 if they are equivalent.
 */
export const compareDates = (a: string | Date, b: string | Date, sortAscending: boolean = false): number => {
...
export const compareMetricAverage = (a: BodyPartMetrics, b: BodyPartMetrics, sortAscending: boolean = false): number => {
